...
namespace Ankh.Sample.Extension
{
    ...
    [ProvideIssueRepositoryConnector(typeof(IssueTracker.AnkhConnector), AppConstants.ConnectorName, typeof(SampleExtensionPackage), "#110")]
    [Guid(GuidList.guidAnkhSampleExtensionPkgString)]
    public sealed class SampleExtensionPackage : Package
    {
        /// <summary>
